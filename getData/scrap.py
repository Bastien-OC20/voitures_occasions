...
for current_page in range(1, 101):
    try:
        ...
        annonces = driver.find_elements(By.CLASS_NAME, "product-card-content")
        ...
        for annonce in annonces:
            try:
                ...
                print(f"Ajouté: {marque_modele, prix, annee, kilometrage, etat, carburant, transmission}")
...
df.to_csv('./data.csv/voitures_aramisauto.csv', index=False)
